...
<body class="bg-slate-700 text-white">
    <div class="max-w-lg mx-auto mt-10 p-6 bg-green-400 shadow-lg rounded-lg">
    ...
    <form action="${pageContext.request.contextPath}/AddTripServlet" method="post" class="space-y-4">
        ...
        <div>
            ...
            <input type="date" name="startDate" required 
                class="w-full mt-1 p-2 border rounded-md focus:ring focus:ring-blue-300 outline-blue-300">
        </div>
