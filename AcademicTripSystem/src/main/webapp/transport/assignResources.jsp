...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="bg-indigo-600 px-6 py-4">
                <h1 class="text-2xl font-bold text-white">Assign Transport Resources</h1>
                <p class="text-indigo-100 mt-1">Assign drivers and vehicles to academic trips</p>
            </div>
            <!-- Alert Messages -->
    ...
    <!-- Use jsp:include instead of the directive include -->
