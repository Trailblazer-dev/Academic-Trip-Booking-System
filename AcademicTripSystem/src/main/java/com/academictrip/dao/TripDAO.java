...
public class TripDAO {
     ...
     * @return List of unique destination names     * Get a list of unique destination names from all trips
     * @throws SQLException if a database error occurs@return List of unique destination names
     */
